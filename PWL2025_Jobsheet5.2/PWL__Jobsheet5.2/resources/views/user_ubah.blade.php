<body>
    ...
    <a href="PWL2025_Jobsheet5.2/PWL__Jobsheet5.2/public/User">Kembali</a>
    <br><br>

    <form method="post" action="/PWL2025_Jobsheet5.2/PWL__Jobsheet5.2/public/User/ubah_simpan/{{ $data->user_id }}">
