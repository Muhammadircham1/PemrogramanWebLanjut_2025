<body>
    ...
    <a href="PWL2025_Jobsheet6/PWL__Jobsheet6/public/User">Kembali</a>
    <br><br>

    <form method="post" action="/PWL2025_Jobsheet6/PWL__Jobsheet6/public/User/ubah_simpan/{{ $data->user_id }}">
